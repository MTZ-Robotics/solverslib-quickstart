...
public class ExampleAprilTagUsage extends OpMode {
    ...
    private final Pose TARGET_LOCATION = new Pose(72,144,Math.toRadians(270)); //Put the target location here

    @Override
    public void init() {
        camera = hardwareMap.get(Limelight3A.class, "limelight");
        follower = Constants.createFollower(hardwareMap);
        follower.setStartingPose(new Pose(60,12,Math.toRadians(90))); //set your starting pose
    }
