...
//@Disabled
@TeleOp
public class A_Tele_lights2 extends CommandOpMode {
    /*********
...
// Assign Variables & Objects for Control Pads
    ...
    public void run() {
        ...
        */
        ...
        topFlywheelLUT.add(DISTANCE_CAL[5], TOP_FLYWHEEL_CAL[5]);
        topFlywheelLUT.add(DISTANCE_CAL[6], TOP_FLYWHEEL_CAL[6]);
        ...
        bottomFlywheelLUT.add(DISTANCE_CAL[5], BOTTOM_FLYWHEEL_CAL[5]);
        bottomFlywheelLUT.add(DISTANCE_CAL[6], BOTTOM_FLYWHEEL_CAL[6]);
 ...
 */
            ...
            flywheelOn.update(gamepad1.right_bumper);
            flywheelOff.update(gamepad1.left_bumper);
            triggerFire = gamepad1.right_trigger;
         ...
         */
            ...
            telemetryData.addData("Top                                  ",topFlywheel.getPower()*100);
            telemetryData.addData("Bottom                            ", bottomFlywheel.getPower()*100);
            ...
            if (targetFound) {
                ...
                telemetry.addData("Tag Range",  "%5.1f inches", desiredTag.ftcPose.range);
                telemetry.addData("Tag Bearing","%3.0f degrees", desiredTag.ftcPose.bearing);
                telemetry.addData("Tag Yaw","%3.0f degrees", desiredTag.ftcPose.yaw);
            }

            telemetryData.addData("Bot X", teleFollower.getPose().getX());
            telemetryData.addData("Bot Y", teleFollower.getPose().getY());
            telemetryData.addData("Bot Heading", teleFollower.getPose().getHeading());
