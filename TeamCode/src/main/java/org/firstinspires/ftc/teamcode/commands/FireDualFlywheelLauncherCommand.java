...
public class FireDualFlywheelLauncherCommand extends SequentialCommandGroup {
    public FireDualFlywheelLauncherCommand(DualFlywheelLauncherSubsystem launcher) {
